 ...
 * @requires PHP 5.6.28
 */
class EventSessionLoggedIn_MalformedReferrerWrongEntityTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\events\SessionEvent::setReferrer: DigitalResource or SoftwareApplication expected');
