 ...
 * @requires PHP 5.6.28
 */
class Entity_MalformedExtensionsNotAStringTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\Entity::setExtensions: associative array expected');
        ...
        (new Person('https://example.edu/users/554433'))
            ...
            ->setExtensions('Not a valid extensions property');
    }
}
