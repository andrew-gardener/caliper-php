 ...
 * @requires PHP 5.6.28
 */
class EventThread_MalformedObjectWrongEntityTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\events\ThreadEvent::setObject: Thread expected');
