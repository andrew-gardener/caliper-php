 ...
 * @requires PHP 5.6.28
 */
class EventResourceManagement_MalformedObjectWrongEntityTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\events\ResourceManagementEvent::setObject: DigitalResource expected');
