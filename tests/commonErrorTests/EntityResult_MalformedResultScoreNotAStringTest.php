 ...
 * @requires PHP 5.6.28
 */
class EntityResult_MalformedResultScoreNotAStringTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\outcome\Result::setResultScore: float expected');
