 ...
 * @requires PHP 5.6.28
 */
class Event_UnknownActionTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        // skipping error message since it includes all the action types
