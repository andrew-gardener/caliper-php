 ...
 * @requires PHP 5.6.28
 */
class EntityAudioObject_MalformedVolumeLevelNotAStringTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\\Caliper\\entities\\media\\AudioObject::setVolumeLevel: string expected');
