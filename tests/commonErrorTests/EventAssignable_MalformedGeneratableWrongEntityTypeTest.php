 ...
 * @requires PHP 5.6.28
 */
class EventAssignable_MalformedGeneratableWrongEntityTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\events\AssignableEvent::setGenerated: Attempt expected');
