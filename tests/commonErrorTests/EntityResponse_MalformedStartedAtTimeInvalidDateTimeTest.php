 ...
 * @requires PHP 5.6.28
 */
class EntityResponse_MalformedStartedAtTimeInvalidDateTimeTest extends CaliperErrorTestCase {
    function testError() {
        ...
        (new Response('https://example.edu/terms/201601/courses/7/sections/1/assess/1/items/6/users/554433/responses/1'))
            ->setAttempt(
                (new Attempt('https://example.edu/terms/201601/courses/7/sections/1/assess/1/items/6/users/554433/attempts/1'))
                    ...
                    ->setCount(1)
                    ->setStartedAtTime(new \DateTime('2016-11-15T10:15:46.000Z'))
                    ->setEndedAtTime(new \DateTime('2016-11-15T10:17:20.000Z'))
            )
            ->setDateCreated(new \DateTime('2016-11-15T10:15:46.000Z'))
            ->setStartedAtTime(new \DateTime('2016-11-15'))
            ->setEndedAtTime(new \DateTime('2016-11-15T10:17:20.000Z'))
            ->setExtensions([
