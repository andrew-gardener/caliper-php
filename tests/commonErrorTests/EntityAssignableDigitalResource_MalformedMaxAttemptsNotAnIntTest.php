 ...
 * @requires PHP 5.6.28
 */
class EntityAssignableDigitalResource_MalformedMaxAttemptsNotAnIntTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\assignable\AssignableDigitalResource::setMaxAttempts: integer expected');
