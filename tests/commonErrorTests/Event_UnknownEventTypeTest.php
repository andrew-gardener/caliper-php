 ...
 * @requires PHP 5.6.28
 */
class Event_UnknownEventTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        // skipping error message since it includes all the event types
        // $this->expectExceptionMessage('');

        (new Event('urn:uuid:cd088ca7-c044-405c-bb41-0b2a8506f907'))
            ->setType(new EventType('NotACaliperEventType'))
            ->setActor(
