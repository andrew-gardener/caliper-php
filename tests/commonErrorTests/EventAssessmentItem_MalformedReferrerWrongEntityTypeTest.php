 ...
 * @requires PHP 5.6.28
 */
class EventAssessmentItem_MalformedReferrerWrongEntityTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\events\AssessmentItemEvent::setReferrer: AssessmentItem expected');
