 ...
 * @requires PHP 5.6.28
 */
class Event_UnknownProfileTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        // skipping error message since it includes all the profile types
        ...
        (new ViewEvent('urn:uuid:cd088ca7-c044-405c-bb41-0b2a8506f907'))
            ...
            ->setProfile(
                new Profile('NotACaliperProfile'))
            ->setAction(
