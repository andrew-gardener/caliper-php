 ...
 * @requires PHP 5.6.28
 */
class EntityAssignableDigitalResource_MalformedMaxScoreNotAFloatTest extends CaliperErrorTestCase {
    function testError() {
        $this->markTestSkipped('Since maxScore is automatically converted from int to float');
