 ...
 * @requires PHP 5.6.28
 */
class EventToolUse_MalformedGeneratedWrongEntityTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\events\ToolUseEvent::setGenerated: AggregateMeasureCollection expected');
