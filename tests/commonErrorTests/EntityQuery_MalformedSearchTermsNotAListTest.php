 ...
 * @requires PHP 5.6.28
 */
class EntityQuery_MalformedSearchTermsNotAListTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\search\Query::setSearchTerms: string expected');
