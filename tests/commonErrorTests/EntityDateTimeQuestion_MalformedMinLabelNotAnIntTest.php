 ...
 * @requires PHP 5.6.28
 */
class EntityDateTimeQuestion_MalformedMinLabelNotAnIntTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\question\DateTimeQuestion::setMinLabel: string expected');
