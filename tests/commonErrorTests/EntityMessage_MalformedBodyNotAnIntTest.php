 ...
 * @requires PHP 5.6.28
 */
class EntityMessage_MalformedBodyNotAnIntTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\Message::setBody: string expected');
