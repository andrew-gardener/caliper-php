 ...
 * @requires PHP 5.6.28
 */
class EntityTrueFalseResponse_MalformedValueNotAnIntTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\response\TrueFalseResponse::setValue: string expecte');
