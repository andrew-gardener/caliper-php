 ...
 * @requires PHP 5.6.28
 */
class EntityQuestionnaireItem_MalformedCategoriesContainsWrongTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\survey\QuestionnaireItem::setCategories: array of string expected');
        ...
        (new QuestionnaireItem('https://example.edu/surveys/100/questionnaires/30/items/1'))
            ...
            ->setCategories(['teaching effectiveness', 'Course structure', 1])
            ->setWeight(1.0);
    }
}
