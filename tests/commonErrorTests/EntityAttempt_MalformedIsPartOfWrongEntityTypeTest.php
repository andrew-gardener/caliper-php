 ...
 * @requires PHP 5.6.28
 */
class EntityAttempt_MalformedIsPartOfWrongEntityTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\assignable\Attempt::setIsPartOf: Attempt expected');
