 ...
 * @requires PHP 5.6.28
 */
class EventFeedback_MalformedGeneratedWrongEntityTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\events\FeedbackEvent::setGenerated: Rating or Comment expected');
