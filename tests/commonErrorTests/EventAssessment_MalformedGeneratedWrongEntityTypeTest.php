 ...
 * @requires PHP 5.6.28
 */
class EventAssessment_MalformedGeneratedWrongEntityTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\events\AssessmentEvent::setGenerated: Attempt expected');
