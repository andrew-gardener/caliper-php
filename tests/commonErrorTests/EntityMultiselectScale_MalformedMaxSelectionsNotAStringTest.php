 ...
 * @requires PHP 5.6.28
 */
class EntityMultiselectScale_MalformedMaxSelectionsNotAStringTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\scale\MultiselectScale::setMaxSelections: integer expected');
