 ...
 * @requires PHP 5.6.28
 */
class EntityAggregateMeasure_MalformedMetricValueNotAStringTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\measure\AggregateMeasure::setMetricValue: float expected');
