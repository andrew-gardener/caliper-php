 ...
 * @requires PHP 5.6.28
 */
class EntityRating_MalformedSelectionsContainsWrongTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\feedback\Rating::setSelections: array of string expected');
