 ...
 * @requires PHP 5.6.28
 */
class EntityMultipleResponseResponse_MalformedValuesContainsWrongTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\response\MultipleResponseResponse::setValues: array of string expected');
