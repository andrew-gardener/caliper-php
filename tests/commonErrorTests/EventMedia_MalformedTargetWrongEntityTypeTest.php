 ...
 * @requires PHP 5.6.28
 */
class EventMedia_MalformedTargetWrongEntityTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\events\MediaEvent::setTarget: MediaLocation expected');
