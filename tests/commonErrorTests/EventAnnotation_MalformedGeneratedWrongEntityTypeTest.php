 ...
 * @requires PHP 5.6.28
 */
class EventAnnotation_MalformedGeneratedWrongEntityTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\events\AnnotationEvent::setGenerated: Annotation expected');
