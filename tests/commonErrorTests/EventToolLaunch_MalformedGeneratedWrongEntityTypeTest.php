 ...
 * @requires PHP 5.6.28
 */
class EventToolLaunch_MalformedGeneratedWrongEntityTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\events\ToolLaunchEvent::setGenerated: DigitalResource expected');
