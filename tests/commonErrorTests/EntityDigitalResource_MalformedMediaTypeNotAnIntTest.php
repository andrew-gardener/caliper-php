 ...
 * @requires PHP 5.6.28
 */
class EntityDigitalResource_MalformedMediaTypeNotAnIntTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\DigitalResource::setMediaType: string expected');
