 ...
 * @requires PHP 5.6.28
 */
class EntityDigitalResource_MalformedLearningObjectivesNotAListTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\DigitalResource::setLearningObjectives: array of LearningObjective expected');
        ...
        (new DigitalResource('https://example.edu/terms/201601/courses/7/sections/1/resources/1/syllabus.pdf'))
            ...
            ->setLearningObjectives('https://example.edu/users/223344')
