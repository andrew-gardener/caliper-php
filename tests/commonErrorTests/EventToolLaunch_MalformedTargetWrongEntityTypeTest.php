 ...
 * @requires PHP 5.6.28
 */
class EventToolLaunch_MalformedTargetWrongEntityTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\events\ToolLaunchEvent::setTarget: Link or LtiLink expected');
