 ...
 * @requires PHP 5.6.28
 */
class EntitySearchResponse_MalformedSearchResultsItemCountNotAStringsTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\search\SearchResponse::setSearchResultsItemCount: integer expected');
