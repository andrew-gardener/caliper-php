 ...
 * @requires PHP 5.6.28
 */
class EntityFillinBlankResponse_MalfromedValuesContainsWrongTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\response\FillinBlankResponse::setValues: array of string expected');
        ...
        (new FillinBlankResponse('https://example.edu/terms/201601/courses/7/sections/1/assess/1/items/1/users/554433/responses/1'))
            ...
            ->setStartedAtTime(new \DateTime('2016-11-15T10:15:02.000Z'))
            ->setEndedAtTime(new \DateTime('2016-11-15T10:15:12.000Z'))
            ->setValues(['data interoperability', 12345, 'semantic interoperability']);
    }
}
