 ...
 * @requires PHP 5.6.28
 */
class EntitySoftwareApplication_MalformedVersionNotAnIntTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\agent\SoftwareApplication::setVersion: string expected');
