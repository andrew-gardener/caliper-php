 ...
 * @requires PHP 5.6.28
 */
class Event_MalformedTargetNotAStringTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\events\Event::setTarget: Entity expected');
        ...
        (new ViewEvent('urn:uuid:cd088ca7-c044-405c-bb41-0b2a8506f907'))
            ...
            ->setTarget('This is not an object or IRI')
            ->setEventTime(
