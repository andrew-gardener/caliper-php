 ...
 * @requires PHP 5.6.28
 */
class EntityMessage_MalformedReplyToWrongEntityTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\Message::setReplyTo: Message expected');
