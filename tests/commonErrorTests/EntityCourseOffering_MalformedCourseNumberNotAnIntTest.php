 ...
 * @requires PHP 5.6.28
 */
class EntityCourseOffering_MalformedCourseNumberNotAnIntTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\\Caliper\\entities\\lis\\CourseOffering::setCourseNumber: string expected');
