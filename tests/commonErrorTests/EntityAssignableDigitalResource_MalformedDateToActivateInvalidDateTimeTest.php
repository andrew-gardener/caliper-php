 ...
 * @requires PHP 5.6.28
 */
class EntityAssignableDigitalResource_MalformedDateToActivateInvalidDateTimeTest extends CaliperErrorTestCase {
    function testError() {
        ...
        (new AssignableDigitalResource('https://example.edu/terms/201601/courses/7/sections/1/assign/2'))
            ...
            ->setDateToActivate(new \DateTime('2016-11-10'))
