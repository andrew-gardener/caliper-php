 ...
 * @requires PHP 5.6.28
 */
class EventGrade_MalformedGeneratedWrongEntityTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\events\GradeEvent::setGenerated: Score expected');
