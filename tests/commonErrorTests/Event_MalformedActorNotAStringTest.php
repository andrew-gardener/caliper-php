 ...
 * @requires PHP 5.6.28
 */
class Event_MalformedActorNotAStringTest extends CaliperErrorTestCase {
    function testError() {
        $this->markTestSkipped('Since errors are not thrown for non iri strings');
        $this->expectException(Exception::class);
        $this->expectExceptionMessage('');

        (new ViewEvent('urn:uuid:cd088ca7-c044-405c-bb41-0b2a8506f907'))
            ->setActor('This is not an object or an IRI')
            ->setProfile(
