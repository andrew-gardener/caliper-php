 ...
 * @requires PHP 5.6.28
 */
class EntityMultiselectScale_MalformedMinSelectionsNotAStringTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\scale\MultiselectScale::setMinSelections: integer expected');
