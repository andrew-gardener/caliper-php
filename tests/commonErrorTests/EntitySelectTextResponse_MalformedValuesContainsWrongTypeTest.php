 ...
 * @requires PHP 5.6.28
 */
class EntitySelectTextResponse_MalformedValuesContainsWrongTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\response\SelectTextResponse::setValues: array of string expected');
        ...
        (new SelectTextResponse('https://example.edu/terms/201601/courses/7/sections/1/assess/1/items/4/users/554433/responses/1'))
            ...
            ->setStartedAtTime(new \DateTime('2016-11-15T10:15:32.000Z'))
            ->setEndedAtTime(new \DateTime('2016-11-15T10:15:38.000Z'))
            ->setValues(['Information Model', 'Sensor API', 'Profiles', 10]);
    }
}