 ...
 * @requires PHP 5.6.28
 */
class EntityScore_MalformedScoredByWrongEntityTypeTest extends CaliperErrorTestCase {
    function testError() {
        ...
        (new Score('https://example.edu/terms/201601/courses/7/sections/1/assess/1/users/554433/attempts/1/scores/1'))
            ...
            ->setScoreGiven(10.0)
            ->setScoredBy(
                (new DigitalResource('https://example.edu/terms/201601/courses/7/sections/1/assess/1'))
            )
