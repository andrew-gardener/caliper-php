 ...
 * @requires PHP 5.6.28
 */
class EntityMultiselectQuestions_MalformedItemLabelsContainWrongTypeTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\question\MultiselectQuestion::setItemLabels: array of string expected');
        ...
        (new MultiselectQuestion('https://example.edu/surveys/100/questionnaires/30/items/4/question'))
            ...
            ->setPoints(4)
            ->setItemLabels(['Calculus', 'Number theory', 'Combinatorics', 'Algebra', 4])
            ->setItemValues([
