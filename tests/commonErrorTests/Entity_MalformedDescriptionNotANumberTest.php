 ...
 * @requires PHP 5.6.28
 */
class Entity_MalformedDescriptionNotANumberTest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\entities\Entity::setDescription: string expected');

        (new Person('https://example.edu/users/554433'))
            ->setDescription(554433)
            ->setOtherIdentifiers([
