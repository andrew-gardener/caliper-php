 ...
 * @requires PHP 5.6.28
 */
class Event_MalformedExtensionsNotAnIRITest extends CaliperErrorTestCase {
    function testError() {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('IMSGlobal\Caliper\events\Event::setExtensions: associative array expected');
